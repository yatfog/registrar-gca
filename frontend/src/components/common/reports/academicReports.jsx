...
const AcademicReports = ({ darkMode = false }) => {
  ...
  const academicData = {
    ...
    gradeDistribution: [
      {
        distribution: "95-100 (With Honors)",
        numStudents: 24,
        percentage: 1.9,
        cumulative: 1.9,
      },
      {
        distribution: "90-94 (Excellent)",
        numStudents: 156,
        percentage: 12.5,
        cumulative: 14.4,
      },
      {
        distribution: "85-89 (Very Good)",
        numStudents: 487,
        percentage: 39.0,
        cumulative: 53.4,
      },
      {
        distribution: "80-84 (Good)",
        numStudents: 423,
        percentage: 33.9,
        cumulative: 87.3,
      },
      {
        distribution: "75-79 (Satisfactory)",
        numStudents: 128,
        percentage: 10.3,
        cumulative: 97.5,
      },
