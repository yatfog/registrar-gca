...
const Pagination = ({ 
  ...
  const startStudent = (currentPage - 1) * studentsPerPage + 1;
  const endStudent = Math.min(currentPage * studentsPerPage, totalStudents);
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-white dark:bg-slate-800 p-4 rounded-lg shadow border border-gray-200 dark:border-slate-700">
      {/* Student count */}
