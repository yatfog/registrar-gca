      ...
      >
        ...
        <div className="flex justify-between items-center bg-yellow-400 text-black dark:text-white px-6 py-4">
          <h2 className="text-lg font-semibold">
            Screening – {fieldValue(applicant.lastName)},{" "}
            {fieldValue(applicant.firstName)}{" "}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6 items-start">
            ...
            <div className="flex flex-col items-end">
              ...
              <div className="flex flex-col gap-2">
                ...
                <button className="w-[190px] px-3.5 py-1.5 rounded bg-green-600 text-black font-semibold hover:bg-green-700 transition">
                  Validate
                </button>
              </div>
            </div>
