    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-2 gap-6 mb-6">
            <div>
              <div className="mb-3">
                ...
                <span className="ml-2 text-gray-900">{student?.name || 'Abella, John T.'}</span>
              </div>
              <div className="mb-3">
                <span className="font-semibold text-gray-700">Student ID:</span>
                <span className="ml-2 text-gray-900">{student?.studentId || 'GCA-2025-003'}</span>
              </div>
              <div className="mb-3">
                <span className="font-semibold text-gray-700">Grade & Section:</span>
          ...
          {/* Exit Details */}
          <div className="mb-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Exit Details</h3>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="text-right">
                <div className="mb-2">
                  ...
                  <span className="text-gray-900 font-medium">{formData.requestDate}</span>
                </div>
                <div className="mb-2">
                  <span className="text-sm text-gray-600">Last Attendance: </span>
                  <span className="text-gray-900 font-medium">{formData.lastAttendance}</span>
                </div>
                <div>
                  <span className="text-sm text-gray-600">New School: </span>
                  <span className="text-gray-900 font-medium">{formData.newSchool}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Clearance Checklist */}
          <div className="mb-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Clearance Checklist</h3>
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 space-y-3">
              <label className="flex items-center cursor-pointer">
                ...
                />
                <span className="ml-3 text-gray-900">Library - No outstanding books</span>
              </label>
              <label className="flex items-center cursor-pointer">
                <input
                  type="checkbox"
                  ...
                  className="w-4 h-4 text-yellow-600 border-gray-300 rounded focus:ring-yellow-500"
                />
                <span className="ml-3 text-gray-900">Finance - No outstanding balances</span>
              </label>
              <label className="flex items-center cursor-pointer">
                <input
                  type="checkbox"
                  ...
                  className="w-4 h-4 text-yellow-600 border-gray-300 rounded focus:ring-yellow-500"
                />
                <span className="ml-3 text-gray-900">Property - All school materials returned</span>
              </label>
              <label className="flex items-center cursor-pointer">
                <input
                  type="checkbox"
                  ...
                  className="w-4 h-4 text-yellow-600 border-gray-300 rounded focus:ring-yellow-500"
                />
                <span className="ml-3 text-gray-900">Advisory Teacher - Clearance Approved</span>
              </label>
            </div>
          </div>
          ...
          <div className="mb-6 bg-gray-100 border border-gray-300 rounded-lg p-4 flex items-center">
            ...
            <div>
              <div className="font-semibold text-gray-900">QR Code Status: <span className="text-green-600">Active</span></div>
              <div className="text-sm text-gray-600">Will be invalidated upon archiving</div>
            </div>
          </div>

          {/* Final Grade and Remarks */}
          <div className="mb-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Final Grade Level and Remarks</h3>
            <div className="grid grid-cols-2 gap-4">
              <div>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) => setFormData({...formData, exitRemarks: e.target.value})}
