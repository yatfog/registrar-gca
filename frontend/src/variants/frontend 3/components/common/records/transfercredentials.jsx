...
const TransferCredentials = () => {
  ...
  const students = [
    { id: 1, name: 'Abuel, Kristine M.', studentId: 'GCA-2025-004', gradeLevel: 'Grade 2', newSchool: "St. Mary's Academy", requestDate: 'Oct 16, 2025', status: 'Requested' },
    { id: 2, name: 'Abella, John T.', studentId: 'GCA-2025-006', gradeLevel: 'Grade 3', newSchool: "St. John's Academy", requestDate: 'Oct 16, 2025', status: 'Requested' },
    { id: 3, name: 'Bordallo, Angelo J.', studentId: 'GCA-2025-011', gradeLevel: 'Grade 4', newSchool: 'Manila Science High', requestDate: 'Oct 20, 2025', status: 'Pending' },
    { id: 4, name: 'Cruz, Catherine S.', studentId: 'GCA-2025-017', gradeLevel: 'Grade 6', newSchool: 'QC Science High', requestDate: 'Oct 21, 2025', status: 'Ready for Pickup' }
  ];
  ...
  const handlePrepareCredentials = (studentId) => console.log(`Preparing credentials for ${studentId}`);
  const handleCompleteTransfer = (studentId) => console.log(`Completing transfer for ${studentId}`);
      ...
      <div className="max-w-7xl mx-auto animate-fadeIn">
        ...
        <div className="bg-white rounded-xl shadow-lg border-2 border-gray-200 p-6 mb-6 transition-all duration-300">
          ...
          <div className="bg-gradient-to-r from-amber-900 via-amber-800 to-stone-900 rounded-xl p-4 flex flex-wrap gap-4 items-center shadow-xl">
            ...
            <div className="flex items-center gap-2">
              <label className="text-white text-sm font-bold">Transfer Status:</label>
              <select
            ...
            <div className="flex items-center gap-2">
              <label className="text-white text-sm font-bold">Request Date:</label>
              <select
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          <div className="bg-white rounded-xl shadow-lg border-2 border-gray-200 p-6 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 hover:scale-105 group cursor-pointer">
            <h3 className="text-gray-600 text-sm font-bold mb-2 tracking-wide uppercase">Pending Transfers</h3>
          ...
          <div className="bg-white rounded-xl shadow-lg border-2 border-gray-200 p-6 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 hover:scale-105 group cursor-pointer">
            <h3 className="text-gray-600 text-sm font-bold mb-2 tracking-wide uppercase">Credentials Generated</h3>
            <p className="text-5xl font-bold text-gray-900 mb-3 group-hover:scale-110 transition-transform">12</p>
            <p className="text-sm text-gray-600 font-medium">This Month</p>
          </div>
          <div className="bg-white rounded-xl shadow-lg border-2 border-gray-200 p-6 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 hover:scale-105 group cursor-pointer">
            <h3 className="text-gray-600 text-sm font-bold mb-2 tracking-wide uppercase">Average Processing Time</h3>
          ...
          <table className="w-full">
            <thead className="bg-gray-50 border-b-2 border-gray-200">
              <tr>
                ...
                <th className="px-6 py-4 text-left text-sm font-bold text-gray-900 tracking-wide">Student Name</th>
                <th className="px-6 py-4 text-left text-sm font-bold text-gray-900 tracking-wide">Student ID</th>
                <th className="px-6 py-4 text-left text-sm font-bold text-gray-900 tracking-wide">Grade Level</th>
                <th className="px-6 py-4 text-left text-sm font-bold text-gray-900 tracking-wide">New School</th>
                <th className="px-6 py-4 text-left text-sm font-bold text-gray-900 tracking-wide">Request Date</th>
                <th className="px-6 py-4 text-left text-sm font-bold text-gray-900 tracking-wide">Status</th>
                <th className="px-6 py-4 text-left text-sm font-bold text-gray-900 tracking-wide">Actions</th>
              </tr>
            </thead>
            <tbody className="bg-white divide-y divide-gray-200">
              {students.map((student) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-sm text-gray-600 font-medium">{student.gradeLevel}</td>
                  <td className="px-6 py-4 text-sm text-gray-600 font-medium">{student.newSchool}</td>
                  <td className="px-6 py-4 text-sm text-gray-600 font-medium">{student.requestDate}</td>
                  <td className="px-6 py-4">
                    <span className={`inline-flex items-center px-3 py-1 text-xs font-medium rounded-full ${getStatusBadge(student.status)} shadow-sm`}>
                      {student.status}
                    </span>
                  </td>
                  <td className="px-6 py-4" onClick={(e) => e.stopPropagation()}>
                    <div className="flex gap-2">
                      {student.status === 'Requested' || student.status === 'Pending' ? (
                        <button
                          onClick={() => handlePrepareCredentials(student.studentId)}
                        ...
                        <button
                          onClick={() => handleCompleteTransfer(student.studentId)}
